...
export const HeaderClient: React.FC<{
  ...
  return (
    <header
      role="banner"
      className={cn("mkdf-page-header", {
        "headerMarginNone": pathname?.includes('/ultimate-adventures') ||
        ...
        "headerMarginDefault": !(pathname?.includes('/ultimate-adventures') ||
          pathname?.includes('/bike-tours') ||
          pathname?.includes('/holiday-packages') ||
          pathname?.includes('/destinations') ||
          pathname?.includes('/posts') ||
              ...
              <ul className="flex gap-2 text-sm">
                {preResolvedNavItems.map((item, index) => (
                  ...
                  >
                    ...
                    {item.submenu && (
                      <div
                        className="absolute top-full left-0 w-64 bg-card border-primary border-t-[3px] rounded-b-xs shadow-lg py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
                      >
                ...
                <div className="flex items-center justify-between py-2">
                  ...
                  {item.submenu && (
                    <button 
                      ...
                      aria-label={mobileActiveDropdown === item.name ? `Collapse ${item.name} submenu` : `Expand ${item.name} submenu`}
                ...
                {item.submenu && (
                  <div
                    className={cn(
                      ...
                      mobileActiveDropdown === item.name ? "max-h-[1000px] opacity-100 mb-4" : "max-h-0 opacity-0"
                    )}
                  >
