          ...
          <main className="lg:col-span-9">
            <div className="mb-12">
              <h1 className="font-oswald text-sm md:text-xl uppercase tracking-tight text-foreground mb-4">
                Ladakh Moto - Holiday Packages
              </h1>
              <p className="text-slate-500 max-w-2xl text-sm">
                Discover the magic of Ladakh with our curated holiday packages. From serene lakes to ancient monasteries.
              </p>
            </div>
            ...
            <div className="flex flex-col">
              {posts.docs?.map((post, index) => (
                <HolidayPackageCard key={index} doc={post} />
              ))}
            </div>
...
export function generateMetadata(): Metadata {
  return {
    title: `Holiday Packages | Ladakh Moto`,
    description: `Discover the magic of Ladakh with our curated holiday packages. From serene lakes to ancient monasteries, explore the beauty of the Himalayas with Ladakh Moto.`,
    alternates: {
