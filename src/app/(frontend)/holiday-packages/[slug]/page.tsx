...
import InclusionExclusionPackageComponent from '@/globals/InclusionExclusionPackage/component'
...
export default async function Post({ params: paramsPromise }: Args) {
  ...
  const url = '/holiday-packages/' + slug
  ...
  return (
    <article className="">
      ...
      <div className="container mx-auto px-4 mt-16 grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-12
        ...
        <div className="col-span-4 md:col-span-8 lg:col-span-9">
          ...
          {/* Content */}
          <div className="col-span-4 md:col-span-8 lg:col-span-9 space-y-4">
            <Overview tourOverview={tourOverview} />
            <Itinerary itineraries={post.itineraries} />
            <Cost cost={post.cost}/>
          </div>
        </div>
        <InclusionExclusionPackageComponent />
...
export async function generateMetadata({ params: paramsPromise }: Args): Promise<Metadata> {
  ...
  return generateMeta({ doc: post, collection: 'holidayPackages' })
}
