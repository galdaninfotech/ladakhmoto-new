  ...
  return (
    <>
      ...
      <div className="fixed bottom-0.5 left-1/2 -translate-x-1/2 z-[120] w-[90%] sm:w-auto max-w-lg">
        <AnimatePresence>
          {showEnquiry && (
            <motion.div
              ...
              className="absolute bottom-full left-1/2 mb-4 w-72.5 sm:w-90 bg-slate-900/95 dark:bg-slate-950/95 backdrop-blur-xl border border-white/10 rounded-xs shadow-2xl p-5 z-[130]"
            >
              <button
                onClick={() => setShowEnquiry(false)}
              ...
              <div className="grid grid-cols-4 gap-2.5">
                <Link
                  ...
                  className="flex flex-col items-center justify-center p-2.5 rounded-xs bg-white/5 hover:bg-emerald-500/10 border border-white/5 hover:border-emerald-500/30 transition-all duration-300 group cursor-pointer"
                >
                  ...
                  <span className="text-[10px] font-oswald tracking-wider uppercase text-slate-400 group-hover:text-slate-200 transition-colors">
                    WhatsApp
                  </span>
                </Link>
                ...
                <Link
                  ...
                  aria-label="Call us"
                  className="flex flex-col items-center justify-center p-2.5 rounded-xs bg-white/5 hover:bg-blue-500/10 border border-white/5 hover:border-blue-500/30 transition-all duration-300 group cursor-pointer"
                >
                ...
                <Link
                  ...
                  className="flex flex-col items-center justify-center p-2.5 rounded-xs bg-white/5 hover:bg-pink-500/10 border border-white/5 hover:border-pink-500/30 transition-all duration-300 group cursor-pointer"
                >
                ...
                <EmailObfuscator
                  ...
                  ariaLabel="Email us"
                  showEmail={false}
                  className="flex flex-col items-center justify-center p-2.5 rounded-xs bg-white/5 hover:bg-indigo-500/10 border border-white/5 hover:border-indigo-500/30 transition-all duration-300 group cursor-pointer"
                >
        ...
        <div className="flex items-center gap-2.5 p-1.5 bg-slate-950/90 dark:bg-slate-950/90 backdrop-blur-lg border border-white/10 rounded-xs shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
          <div className="hidden sm:flex items-center gap-2 pl-4 pr-2 select-none">
            <Compass
              className="w-4 h-4 text-accent animate-spin"
              style={{ animationDuration: '8s' }}
            />
            <span className="font-oswald uppercase tracking-widest text-[11.5px] text-white font-semibold">
              Ladakh Moto
            </span>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              <SheetContent className="bg-slate-950 text-white border-l border-white/10 overflow-y-auto w-full sm:max-w-md">
                <SheetHeader className="mb-6 relative">
                  <SheetTitle className="mb-4 text-left font-oswald text-white text-lg before:content-[''] before:absolute before:left-0 before:bottom-[7px] before:h-[4px] before:w-[85px] before:bg-accent after:content-[''] after:absolute after:left-0 after:bottom-[8.5px] after:h-[1px] after:w-[132px] after:max-w-[180px] after:bg-white/20 after:-z-1">
                    INSTANT BOOKING
                  </SheetTitle>
                </SheetHeader>
                ...
                <div className="recaptcha-terms text-xs/5 text-slate-400 relative -bottom-6">
            ...
            <Button
              ...
              className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold font-oswald uppercase tracking-wider rounded-xs border border-white/15 transition-all hover:scale-105 active:scale-95 shadow-md cursor-pointer"
            >
