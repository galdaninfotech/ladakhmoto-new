  ...
  return {
    ...
    layout: [
      ...
      },
      {
        ...
        subTitle: 'Exclusive Ride Package',
        description: 'Conquer the highest motorable passes in the world, ride along the pristine Pangong Lake.',
        startDate: '2026-07-20T00:00:00.000Z',
        endDate: '2026-07-30T00:00:00.000Z',
        price: 'Starting at ₹15,500.00',
        url: '/bike-tours/leh-ladakh-adventure',
        buttonText: 'Book This Deal',
      },
      {
        enabled: true,
        title: null,
